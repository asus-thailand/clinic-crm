...
// ... (ส่วนที่เหลือของไฟล์เหมือนเดิม จนถึง handleSaveEditForm)
    ...
    try {
        ...
        for (const [key, value] of Object.entries(updatedData)) {
            if (String(originalCustomer[key] || '') !== String(value)) {
                // โค้ดที่แก้ไข: ใช้ ui.FIELD_MAPPING จากส่วนกลางเพื่อหาชื่อ Header
                // ซึ่งแก้ปัญหาการสะกดผิดและทำให้โค้ดอ้างอิงจากที่เดียว
...
// ... (โค้ดส่วนที่เหลือของไฟล์ main.js ไม่มีการเปลี่ยนแปลง)
